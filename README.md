This helps me to found any bank near from my work in Cairo Maadi, If you live in Maadi in Egypt this web application may help you to find the nearest bank from you.

## How to use the application
When you open the application, it will list all the banks near Maadi, You can search for any bank using the search box on the left side from the screen.

## Technology
I used [Foursquare] (https://foursquare.com) API's to get the banks data.
I used Plain JavaScript to handle the API's and the rest of the logic code, ES6 helps me because I can use the fetch API to handle the data asynchronously.
I have used React framework with `create react app` command then I have customized the application with my code, and for the style, I have used CSS without any third party frameworks for the style.

## Sending Feedback

We are always open to shahaitham@gmail.com


Note: all those below instructions belong to the react app readme file.
